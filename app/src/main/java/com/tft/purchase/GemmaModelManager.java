...
public final class GemmaModelManager {
    public static final String MODEL_FILE = "gemma-4-E2B-it.litertlm";
    public static final long EXPECTED_SIZE = 2588147712L;
    private static final String PREFS = "tft_settings";
    private static final String KEY_DOWNLOAD_ID = "gemma_download_id";
    private static final String URL = "https://huggingface.co/litert-community/gemma-4-E2B-it-litert-lm/resolve/main/gemma-4-E2B-it.litertlm?download=true";
    ...
    public static boolean isReady(Context context) {
        ...
        return f.exists() && f.length() > 2_400_000_000L;
    }
    ...
    public static long startDownload(Context context) throws Exception {
        ...
        req.setTitle("全益採購追蹤｜Gemma AI 模型");
        req.setDescription("正在下載約 2.6 GB 的離線 AI 模型，下載完成後可用圖片 AI 辨識採購單。");
